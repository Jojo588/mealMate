...
// hide suggestions section when the search button is being filled
...
{    check? <h1 className="text-2xl font-bold mb-4 capitalize">monitor expiring Food Items</h1>:<h1 className="text-2xl font-bold mb-4 capitalize">search results</h1>
}
